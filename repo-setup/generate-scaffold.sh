...
echo "  2. Создать репо на GitHub: gh repo create b3axap/${REPO_NAME} --public"
echo "  3. cd ${TARGET} && git init -b main && git add . && git commit -m 'feat: scaffold'"
echo "  4. git remote add origin https://github.com/b3axap/${REPO_NAME}.git && git push -u origin main"
